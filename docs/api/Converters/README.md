...
Here you can find a list of methods that are used to convert an Enumerable to another data structure.
...
- [toIterator()](ToIterator.md)
- [toJSON()](ToJSON.md)
- [toList()](ToList.md)
- [toLocaleString()](ToLocaleString.md)
- [toMap(getKey, getValue)](ToMap.md)
